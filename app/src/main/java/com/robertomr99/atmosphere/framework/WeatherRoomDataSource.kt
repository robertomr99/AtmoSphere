...
import com.robertomr99.atmosphere.framework.database.DbForecastEntity
import com.robertomr99.atmosphere.framework.database.DbWeatherEntity
import com.robertomr99.atmosphere.framework.database.DbWeatherWithForecastsEntity
import com.robertomr99.atmosphere.framework.database.WeatherDao
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map

class WeatherRoomDataSource(private val weatherDao: WeatherDao) :
    ...
    private fun DbWeatherEntity.toDomainWeather() = WeatherEntity(
        cityId = cityId,
        name = name,
        country = country,
    ...
    private fun DbForecastEntity.toDomainForecast() = ForecastEntity(
        id = 0,
    ...
    private fun DbWeatherWithForecastsEntity.toDomainWeatherWithForecast() = WeatherWithForecasts(
