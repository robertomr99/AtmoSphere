...
fun TopBarHomeActions(
    homeState: HomeState,
    onUnitSelected: (com.robertomr99.atmosphere.weather.TemperatureUnit) -> Unit
) {
    Box {
...
fun TemperatureMenu(
    expanded: Boolean,
    selectedUnit: com.robertomr99.atmosphere.weather.TemperatureUnit,
    onDismiss: () -> Unit,
    onUnitSelected: (com.robertomr99.atmosphere.weather.TemperatureUnit) -> Unit
) {
    DropdownMenu(
...
fun TemperatureMenuItem(
    unit: com.robertomr99.atmosphere.weather.TemperatureUnit,
    selectedUnit: com.robertomr99.atmosphere.weather.TemperatureUnit,
    label: String,
    symbol: String,
    onClick: () -> Unit
