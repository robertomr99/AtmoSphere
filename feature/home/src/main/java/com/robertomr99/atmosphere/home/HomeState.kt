...
class HomeState @OptIn(ExperimentalMaterial3Api::class) constructor(
    ...
    var selectedTemperatureUnit by mutableStateOf(com.robertomr99.atmosphere.weather.TemperatureUnit.CELSIUS)
        private set
    ...
    fun setTemperatureUnit(unit: com.robertomr99.atmosphere.weather.TemperatureUnit) {
...
fun rememberHomeState(
    ...
    temperatureUnit: com.robertomr99.atmosphere.weather.TemperatureUnit = com.robertomr99.atmosphere.weather.TemperatureUnit.CELSIUS
): HomeState {
